...
IplImage* median_filter(IplImage* img)
{
	...
	cvNamedWindow("Median_filtered", CV_WINDOW_AUTOSIZE);
	cvShowImage("Median_filtered", filtered);
	cvSaveImage("Median_filtered.bmp", filtered);
	printf("\n Saved Successfully \n\n");
